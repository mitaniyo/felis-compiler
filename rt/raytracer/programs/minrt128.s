...
sgn.2745:
	...
	mfc1	f30 r25
	sll	r25 r25 1
	beq	r25 r0 bfeq_nontail_else.8374
	addi	r0 r1 0
	j	bfeq_nontail_cont.8375
bfeq_nontail_else.8374:
	addi	r0 r1 1
bfeq_nontail_cont.8375:
	addi	r0 r2 0
	sub	r1 r2 r25
...
beq_tail_else.8376:
	...
	sub.s	f0 f1 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8377
	addi	r0 r1 1
	j	bfle_nontail_cont.8378
bfle_nontail_else.8377:
	addi	r0 r1 0
bfle_nontail_cont.8378:
	addi	r0 r2 0
	sub	r1 r2 r25
...
vecunit_sgn.2771:
	...
	mfc1	f30 r25
	sll	r25 r25 1
	beq	r25 r0 bfeq_nontail_else.8385
	addi	r0 r3 0
	j	bfeq_nontail_cont.8386
bfeq_nontail_else.8385:
	addi	r0 r3 1
bfeq_nontail_cont.8386:
	addi	r0 r4 0
	sub	r3 r4 r25
	beq	r25 r0 beq_else.8387
	lui	r24 16256
	ori	r24 r24 0
	mtc1	r24 f0
	j	beq_cont.8388
...
beq_cont.8406:
	...
	addi	r0 r2 3
	sub	r5 r2 r25
	beq	r25 r0 beq_else.8407
	addi	r0 r2 2
	sub	r5 r2 r25
	beq	r25 r0 beq_else.8409
	j	beq_cont.8410
beq_else.8409:
	addi	r0 r2 0
	lw	r30 r5 56
...
beq_else.8407:
	...
	mfc1	f30 r25
	sll	r25 r25 1
	beq	r25 r0 bfeq_nontail_else.8413
	addi	r0 r5 0
	j	bfeq_nontail_cont.8414
bfeq_nontail_else.8413:
	addi	r0 r5 1
bfeq_nontail_cont.8414:
	addi	r0 r6 0
	sw	r2 r30 108
	sub	r5 r6 r25
	beq	r25 r0 beq_else.8415
	mtc1	r0 f0
	j	beq_cont.8416
beq_else.8415:
	swc1	f0 r30 112
...
beq_cont.8416:
	...
	mfc1	f30 r25
	sll	r25 r25 1
	beq	r25 r0 bfeq_nontail_else.8417
	addi	r0 r3 0
	j	bfeq_nontail_cont.8418
bfeq_nontail_else.8417:
	addi	r0 r3 1
bfeq_nontail_cont.8418:
	addi	r0 r4 0
	sw	r1 r30 116
	sub	r3 r4 r25
...
beq_cont.8420:
	...
	mfc1	f30 r25
	sll	r25 r25 1
	beq	r25 r0 bfeq_nontail_else.8421
	addi	r0 r3 0
	j	bfeq_nontail_cont.8422
bfeq_nontail_else.8421:
	addi	r0 r3 1
bfeq_nontail_cont.8422:
	addi	r0 r4 0
	sw	r1 r30 124
	sub	r3 r4 r25
...
solver_rect_surface.2893:
	...
	mfc1	f30 r25
	sll	r25 r25 1
	beq	r25 r0 bfeq_nontail_else.8436
	addi	r0 r6 0
	j	bfeq_nontail_cont.8437
bfeq_nontail_else.8436:
	addi	r0 r6 1
bfeq_nontail_cont.8437:
	addi	r0 r7 0
	sub	r6 r7 r25
...
bfle_nontail_cont.8440:
	...
	sub.s	f1 f2 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8441
	addi	r0 r1 1
	j	bfle_nontail_cont.8442
bfle_nontail_else.8441:
	addi	r0 r1 0
bfle_nontail_cont.8442:
	addi	r0 r3 0
	sub	r1 r3 r25
	beq	r25 r0 beq_tail_else.8443
	lw	r30 r1 4
	sll	r1 r3 2
	lwoc1	r4 r3 f1
	sll	r1 r1 2
...
solver_surface.2908:
	...
	sub.s	f0 f1 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8450
	addi	r0 r1 1
	j	bfle_nontail_cont.8451
bfle_nontail_else.8450:
	addi	r0 r1 0
bfle_nontail_cont.8451:
	addi	r0 r2 0
	sub	r1 r2 r25
...
solver_second.2927:
	...
	mfc1	f30 r25
	sll	r25 r25 1
	beq	r25 r0 bfeq_nontail_else.8455
	addi	r0 r1 0
	j	bfeq_nontail_cont.8456
bfeq_nontail_else.8455:
	addi	r0 r1 1
bfeq_nontail_cont.8456:
	addi	r0 r2 0
	sub	r1 r2 r25
...
beq_cont.8459:
	...
	sub.s	f0 f2 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8460
	addi	r0 r1 1
	j	bfle_nontail_cont.8461
bfle_nontail_else.8460:
	addi	r0 r1 0
bfle_nontail_cont.8461:
	addi	r0 r2 0
	sub	r1 r2 r25
...
solver_rect_fast.2937:
	...
	sub.s	f0 f1 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8467
	addi	r0 r1 1
	j	bfle_nontail_cont.8468
bfle_nontail_else.8467:
	addi	r0 r1 0
bfle_nontail_cont.8468:
	addi	r0 r3 0
	sub	r1 r3 r25
	beq	r25 r0 beq_else.8469
	lw	r30 r1 12
	sw	r31 r30 28
	addi	r30 r30 32
	jal	o_param_c.2813
	...
	sub.s	f0 f1 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8471
	addi	r0 r1 1
	j	bfle_nontail_cont.8472
bfle_nontail_else.8471:
	addi	r0 r1 0
bfle_nontail_cont.8472:
	addi	r0 r3 0
	sub	r1 r3 r25
...
bfle_nontail_cont.8481:
	...
	sub.s	f0 f1 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8484
	addi	r0 r1 1
	j	bfle_nontail_cont.8485
bfle_nontail_else.8484:
	addi	r0 r1 0
bfle_nontail_cont.8485:
	addi	r0 r3 0
	sub	r1 r3 r25
	beq	r25 r0 beq_else.8486
	addi	r0 r1 3
	sll	r1 r1 2
	lw	r30 r3 4
	lwoc1	r3 r1 f0
	...
	mfc1	f30 r25
	sll	r25 r25 1
	beq	r25 r0 bfeq_nontail_else.8488
	addi	r0 r1 0
	j	bfeq_nontail_cont.8489
bfeq_nontail_else.8488:
	addi	r0 r1 1
bfeq_nontail_cont.8489:
	addi	r0 r4 0
	sub	r1 r4 r25
	beq	r25 r0 beq_else.8490
	addi	r0 r1 0
	j	beq_cont.8491
beq_else.8490:
	addi	r0 r1 1
...
bfle_nontail_cont.8498:
	...
	mfc1	f30 r25
	sll	r25 r25 1
	beq	r25 r0 bfeq_nontail_else.8501
	addi	r0 r1 0
	j	bfeq_nontail_cont.8502
bfeq_nontail_else.8501:
	addi	r0 r1 1
bfeq_nontail_cont.8502:
	addi	r0 r2 0
	sub	r1 r2 r25
...
solver_surface_fast.2944:
	...
	sub.s	f3 f4 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8506
	addi	r0 r1 1
	j	bfle_nontail_cont.8507
bfle_nontail_else.8506:
	addi	r0 r1 0
bfle_nontail_cont.8507:
	addi	r0 r3 0
	sub	r1 r3 r25
	beq	r25 r0 beq_tail_else.8508
	addi	r30 r30 0
	sw	r1 r30 0
	sw	r31 r30 4
	jal	min_caml_load_solver_dist
...
solver_second_fast.2950:
	...
	mfc1	f30 r25
	sll	r25 r25 1
	beq	r25 r0 bfeq_nontail_else.8509
	addi	r0 r3 0
	j	bfeq_nontail_cont.8510
bfeq_nontail_else.8509:
	addi	r0 r3 1
bfeq_nontail_cont.8510:
	addi	r0 r4 0
	sub	r3 r4 r25
	beq	r25 r0 beq_tail_else.8511
	addi	r0 r1 0
	jr	r31
beq_tail_else.8511:
	addi	r0 r3 1
...
beq_cont.8513:
	...
	sub.s	f0 f2 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8514
	addi	r0 r1 1
	j	bfle_nontail_cont.8515
bfle_nontail_else.8514:
	addi	r0 r1 0
bfle_nontail_cont.8515:
	addi	r0 r2 0
	sub	r1 r2 r25
...
solver_second_fast2.2967:
	...
	mfc1	f30 r25
	sll	r25 r25 1
	beq	r25 r0 bfeq_nontail_else.8524
	addi	r0 r4 0
	j	bfeq_nontail_cont.8525
bfeq_nontail_else.8524:
	addi	r0 r4 1
bfeq_nontail_cont.8525:
	addi	r0 r5 0
	sub	r4 r5 r25
	beq	r25 r0 beq_tail_else.8526
	addi	r0 r1 0
	jr	r31
beq_tail_else.8526:
	addi	r0 r4 1
	...
	sub.s	f1 f2 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8527
	addi	r0 r3 1
	j	bfle_nontail_cont.8528
bfle_nontail_else.8527:
	addi	r0 r3 0
bfle_nontail_cont.8528:
	addi	r0 r4 0
	sub	r3 r4 r25
...
setup_rect_table.2977:
	...
	mfc1	f30 r25
	sll	r25 r25 1
	beq	r25 r0 bfeq_nontail_else.8534
	addi	r0 r2 0
	j	bfeq_nontail_cont.8535
bfeq_nontail_else.8534:
	addi	r0 r2 1
bfeq_nontail_cont.8535:
	addi	r0 r4 0
	sw	r1 r30 8
	sub	r2 r4 r25
	beq	r25 r0 beq_else.8536
	addi	r0 r2 1
	mtc1	r0 f0
	sll	r2 r2 2
	swoc1	f0 r1 r2
...
beq_else.8536:
	...
	sub.s	f0 f1 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8538
	addi	r0 r2 1
	j	bfle_nontail_cont.8539
bfle_nontail_else.8538:
	addi	r0 r2 0
bfle_nontail_cont.8539:
	sw	r31 r30 16
	addi	r30 r30 20
	jal	xor.2742
	addi	r30 r30 -20
...
beq_cont.8537:
	...
	mfc1	f30 r25
	sll	r25 r25 1
	beq	r25 r0 bfeq_nontail_else.8540
	addi	r0 r1 0
	j	bfeq_nontail_cont.8541
bfeq_nontail_else.8540:
	addi	r0 r1 1
bfeq_nontail_cont.8541:
	addi	r0 r3 0
	sub	r1 r3 r25
...
beq_cont.8543:
	...
	mfc1	f30 r25
	sll	r25 r25 1
	beq	r25 r0 bfeq_nontail_else.8546
	addi	r0 r1 0
	j	bfeq_nontail_cont.8547
bfeq_nontail_else.8546:
	addi	r0 r1 1
bfeq_nontail_cont.8547:
	addi	r0 r3 0
	sub	r1 r3 r25
	beq	r25 r0 beq_else.8548
	addi	r0 r1 5
	mtc1	r0 f0
	sll	r1 r1 2
	lw	r30 r2 8
...
beq_cont.8557:
	...
	mfc1	f30 r25
	sll	r25 r25 1
	beq	r25 r0 bfeq_nontail_else.8558
	addi	r0 r1 0
	j	bfeq_nontail_cont.8559
bfeq_nontail_else.8558:
	addi	r0 r1 1
bfeq_nontail_cont.8559:
	addi	r0 r3 0
	sub	r1 r3 r25
...
ble_tail_else.8568:
	...
	addi	r0 r1 2
	sub	r3 r1 r25
	blez	r25 ble_nontail_else.8572
	addi	r0 r1 0
	sll	r1 r1 2
	lwoc1	r2 r1 f0
	addi	r0 r1 1
...
beq_cont.8575:
	...
	lw	r30 r2 12
	swoc1	f0 r2 r1
	j	ble_nontail_cont.8573
ble_nontail_else.8572:
ble_nontail_cont.8573:
	j	beq_cont.8571
beq_else.8570:
	addi	r0 r1 3
	lw	r30 r3 8
...
is_rect_outside.2996:
	...
	sub.s	f0 f1 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8576
	addi	r0 r1 1
	j	bfle_nontail_cont.8577
bfle_nontail_else.8576:
	addi	r0 r1 0
bfle_nontail_cont.8577:
	addi	r0 r2 0
	sub	r1 r2 r25
	...
	sub.s	f0 f1 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8580
	addi	r0 r1 1
	j	bfle_nontail_cont.8581
bfle_nontail_else.8580:
	addi	r0 r1 0
bfle_nontail_cont.8581:
	addi	r0 r2 0
	sub	r1 r2 r25
...
beq_cont.8592:
	...
	sub.s	f0 f1 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8593
	addi	r0 r2 1
	j	bfle_nontail_cont.8594
bfle_nontail_else.8593:
	addi	r0 r2 0
bfle_nontail_cont.8594:
	sw	r31 r30 12
	addi	r30 r30 16
	jal	xor.2742
	addi	r30 r30 -16
...
shadow_check_and_group.3022:
	...
	sub.s	f1 f2 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8603
	addi	r0 r1 1
	j	bfle_nontail_cont.8604
bfle_nontail_else.8603:
	addi	r0 r1 0
bfle_nontail_cont.8604:
	j	beq_cont.8602
beq_else.8601:
	addi	r0 r1 0
beq_cont.8602:
...
solve_each_element.3031:
	...
	sub.s	f1 f2 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8625
	addi	r0 r2 1
	j	bfle_nontail_cont.8626
bfle_nontail_else.8625:
	addi	r0 r2 0
bfle_nontail_cont.8626:
	addi	r0 r3 0
	sub	r2 r3 r25
...
judge_intersection.3043:
	...
	sub.s	f1 f2 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8650
	addi	r0 r1 1
	j	bfle_nontail_cont.8651
bfle_nontail_else.8650:
	addi	r0 r1 0
bfle_nontail_cont.8651:
	addi	r0 r2 0
	sub	r1 r2 r25
...
solve_each_element_fast.3045:
	...
	sub.s	f1 f2 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8656
	addi	r0 r2 1
	j	bfle_nontail_cont.8657
bfle_nontail_else.8656:
	addi	r0 r2 0
bfle_nontail_cont.8657:
	addi	r0 r3 0
	sub	r2 r3 r25
...
trace_or_matrix_fast.3053:
	...
	sub.s	f0 f1 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8676
	addi	r0 r1 1
	j	bfle_nontail_cont.8677
bfle_nontail_else.8676:
	addi	r0 r1 0
bfle_nontail_cont.8677:
	addi	r0 r2 0
	sub	r1 r2 r25
...
get_nvector.3065:
	...
	addi	r0 r2 1
	sub	r1 r2 r25
	beq	r25 r0 beq_tail_else.8689
	addi	r0 r2 2
	sub	r1 r2 r25
	beq	r25 r0 beq_tail_else.8690
	lw	r30 r1 0
...
beq_tail_else.8694:
	...
	sub.s	f3 f4 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8696
	addi	r0 r1 1
	j	bfle_nontail_cont.8697
bfle_nontail_else.8696:
	addi	r0 r1 0
bfle_nontail_cont.8697:
	addi	r0 r2 0
	swc1	f2 r30 56
	sub	r1 r2 r25
	beq	r25 r0 beq_else.8698
	lui	r24 16752
	ori	r24 r24 0
	mtc1	r24 f0
	j	beq_cont.8699
...
beq_cont.8699:
	...
	sub.s	f1 f3 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8700
	addi	r0 r1 1
	j	bfle_nontail_cont.8701
bfle_nontail_else.8700:
	addi	r0 r1 0
bfle_nontail_cont.8701:
	addi	r0 r2 0
	sub	r1 r2 r25
	beq	r25 r0 beq_else.8702
	lui	r24 16752
	ori	r24 r24 0
	mtc1	r24 f0
	j	beq_cont.8703
...
beq_cont.8703:
	...
	sub.s	f1 f0 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8704
	addi	r0 r1 1
	j	bfle_nontail_cont.8705
bfle_nontail_else.8704:
	addi	r0 r1 0
bfle_nontail_cont.8705:
	addi	r0 r2 0
	sub	r1 r2 r25
	beq	r25 r0 beq_else.8706
	mtc1	r0 f0
	j	beq_cont.8707
beq_else.8706:
beq_cont.8707:
...
beq_tail_else.8691:
	...
	sub.s	f0 f1 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8711
	addi	r0 r1 1
	j	bfle_nontail_cont.8712
bfle_nontail_else.8711:
	addi	r0 r1 0
bfle_nontail_cont.8712:
	addi	r0 r2 2
	sll	r2 r2 2
	lw	r30 r3 0
	lwoc1	r3 r2 f0
	...
	sub.s	f0 f1 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8713
	addi	r0 r1 1
	j	bfle_nontail_cont.8714
bfle_nontail_else.8713:
	addi	r0 r1 0
bfle_nontail_cont.8714:
	addi	r30 r30 128
	sw	r1 r30 0
	sw	r31 r30 4
	jal	min_caml_load_texture_color
...
add_light.3071:
	...
	sub.s	f0 f3 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8722
	addi	r0 r1 1
	j	bfle_nontail_cont.8723
bfle_nontail_else.8722:
	addi	r0 r1 0
bfle_nontail_cont.8723:
	addi	r0 r2 0
	swc1	f2 r30 0
	swc1	f1 r30 4
	sub	r1 r2 r25
...
beq_cont.8725:
	...
	sub.s	f1 f0 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8726
	addi	r0 r1 1
	j	bfle_nontail_cont.8727
bfle_nontail_else.8726:
	addi	r0 r1 0
bfle_nontail_cont.8727:
	addi	r0 r2 0
	sub	r1 r2 r25
	beq	r25 r0 beq_tail_else.8728
	mul.s	f1 f1 f0
	mul.s	f1 f1 f1
	mul.s	f0 f1 f0
	lwc1	 r30 f1 0
...
ble_tail_else.8739:
	...
	sub.s	f0 f1 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8742
	addi	r0 r1 1
	j	bfle_nontail_cont.8743
bfle_nontail_else.8742:
	addi	r0 r1 0
bfle_nontail_cont.8743:
	addi	r0 r2 0
	sub	r1 r2 r25
	beq	r25 r0 beq_else.8744
	addi	r0 r1 0
	lw	r30 r2 12
	sll	r2 r3 2
	lw	r30 r4 40
...
beq_cont.8747:
	...
	sub.s	f0 f2 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8748
	addi	r0 r1 1
	j	bfle_nontail_cont.8749
bfle_nontail_else.8748:
	addi	r0 r1 0
bfle_nontail_cont.8749:
	addi	r0 r2 0
	sub	r1 r2 r25
	beq	r25 r0 beq_tail_else.8750
	addi	r0 r1 4
	lw	r30 r2 12
	sub	r1 r2 r25
...
beq_tail_else.8741:
	...
	sub.s	f0 f1 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8757
	addi	r0 r1 1
	j	bfle_nontail_cont.8758
bfle_nontail_else.8757:
	addi	r0 r1 0
bfle_nontail_cont.8758:
	addi	r0 r2 0
	sub	r1 r2 r25
...
beq_tail_else.8764:
	...
	sub.s	f0 f1 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8766
	addi	r0 r1 1
	j	bfle_nontail_cont.8767
bfle_nontail_else.8766:
	addi	r0 r1 0
bfle_nontail_cont.8767:
	addi	r0 r2 0
	sub	r1 r2 r25
	beq	r25 r0 beq_else.8768
	j	beq_cont.8769
beq_else.8768:
	mtc1	r0 f0
beq_cont.8769:
...
ble_tail_else.8771:
	...
	sub.s	f1 f0 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8773
	addi	r0 r1 1
	j	bfle_nontail_cont.8774
bfle_nontail_else.8773:
	addi	r0 r1 0
bfle_nontail_cont.8774:
	addi	r0 r2 0
	sub	r1 r2 r25
...
write_rgb_element.3136:
	...
	addi	r0 r2 255
	sub	r1 r2 r25
	blez	r25 ble_nontail_else.8808
	addi	r0 r1 255
	j	ble_nontail_cont.8809
ble_nontail_else.8808:
	addi	r0 r2 0
	sub	r2 r1 r25
	blez	r25 ble_nontail_else.8810
	addi	r0 r1 0
	j	ble_nontail_cont.8811
ble_nontail_else.8810:
ble_nontail_cont.8811:
ble_nontail_cont.8809:
...
scan_line.3160:
	...
	sw	r1 r30 16
	sub	r6 r1 r25
	blez	r25 ble_nontail_else.8825
	addi	r0 r6 1
	add	r1 r6 r6
	sw	r31 r30 20
	addi	r30 r30 24
	...
	addi	r30 r30 -24
	lw	r30 r31 20
	j	ble_nontail_cont.8826
ble_nontail_else.8825:
ble_nontail_cont.8826:
	addi	r0 r1 0
	lw	r30 r2 16
	lw	r30 r3 12
	lw	r30 r4 8
...
beq_tail_else.8847:
	...
	sub.s	f0 f1 f30
	mfc1	f30 r25
	blez	r25 bfle_nontail_else.8849
	addi	r0 r1 1
	j	bfle_nontail_cont.8850
bfle_nontail_else.8849:
	addi	r0 r1 0
bfle_nontail_cont.8850:
	addi	r0 r2 0
	sub	r1 r2 r25
	beq	r25 r0 beq_tail_else.8851
	lw	r30 r1 4
	sw	r31 r30 12
	addi	r30 r30 16
	jal	o_form.2801
	...
	addi	r0 r2 1
	sub	r1 r2 r25
	beq	r25 r0 beq_tail_else.8852
	addi	r0 r2 2
	sub	r1 r2 r25
	beq	r25 r0 beq_tail_else.8853
	jr	r31
beq_tail_else.8853:
	lw	r30 r1 0
	lw	r30 r2 4
